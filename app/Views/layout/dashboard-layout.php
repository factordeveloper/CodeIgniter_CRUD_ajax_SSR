...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">IrebeLibrary</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <!-- Sidebar Menu -->
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacyx nav-child-indent nav-collapse-hide-child nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= route_to('countries') ?>" class="nav-link <?= (current_url() == base_url('user/countries')) ? 'active' : ''; ?>">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2014-2021 <a href="<?= base_url(); ?>">IrebeLibrary</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
